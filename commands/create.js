...
module.exports.run = async (client, message) => {
    ...
    if (
      ...
      return message.reply(
        ":x: Vous devez avoir la permissions de créer un giveways."
      );
    }
  ...
  .setTitle("Oups, le délai a expiré! 🕖")
  .setColor("#FF0000")
  ...
  await waitingEmbed('Prize', 'Saisir le cadeau.');
    ...
    switch (true) {
      case !prize: {
        if (m.content.length > 256)
          ...
          prize = m.content;
          await waitingEmbed('Channel', 'Envoyer le salon giveways svp.');
        }
